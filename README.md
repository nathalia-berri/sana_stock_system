...
RNF02 - Transações ACID para integridade de estoque (MariaDB)

RNF03 - Senhas criptografadas (bcrypt)

RNF04 - Performance < 500ms para movimentações

RNF05 - Interface responsiva desktop/mobile (React)
...
- **Banco de Dados: MariaDB (MySQL)**, suporta todas as tabelas e relacionamentos definidos (categorias, materiais, funcionarios, users, movimentacoes), com transações ACID, chaves estrangeiras e performance otimizada para relatórios.
...
**👨‍💻 Anselmo:**
- [ ] MariaDB config (Docker/local) + SQLAlchemy model User
...
- [ ] Deploy final: Railway (backend+MariaDB) + Vercel (React)
...
- SQLAlchemy para comunicação segura com MariaDB
- Validações Pydantic automáticas

**Banco de Dados (MariaDB):**
- Reaproveita modelo lógico existente (5 tabelas principais)
- Transações ACID garantem integridade de estoque
- Chaves estrangeiras para relacionamentos corretos
